# PSOC&trade; Control C1 MCU: CAN transmitter

This example demonstrates how to transmit CAN messages over the CAN bus using the PSOC&trade; Control C1 MCU. This example can be used with the [CAN receiver](https://github.com/Infineon/mtb-example-ce242892-can-receiver) example running on another board.

[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce242893-can-transmitter)

[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
Two PSOC&trade; Control C1 Evaluation Kits are required to test this code example: one for the [PSOC&trade; C1: CAN Receiver](https://github.com/Infineon/mtb-example-ce242892-can-receiver) application and the other for the [PSOC&trade; C1: CAN Transmitter](https://github.com/Infineon/mtb-example-ce242893-can-transmitter) application.
...
The following example clones the "[CAN transmitter](https://github.com/Infineon/mtb-example-ce242893-can-transmitter)" application with the desired name "CAN transmitter" configured for the *KIT_PSC1M3_EVK* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSC1M3_EVK --app-id mtb-example-ce242893-can-transmitter --user-app-name CANTransmitter --target-dir "C:/mtb_projects"
   ```
...
4. Confirm that the user 'User LED1' toggles on the transmitter board, which confirms that the CAN frame is transmitted periodically
...
**Note:** `KIT_PSC1M3_EVK` does not have an on-board user switch. Connect an external switch to pin P2.4 to test the example.
...
| :------- | :------------    | :------------ |
| CAN (PDL) | CAN_NODE | CAN node for transmitting messages |
...
Document title: *CE242893* – *PSOC&trade; Control C1 MCU: CAN transmitter*
